...
slides_package: study/slides/TOPIC-000/slides.zip
...
A mesma versão materializada também gera fontes HTML internas em `slides`, o pacote learner-facing em `slides_package` e a revisão especializada em `slides_review`. Somente o ZIP aparece na aula e nas ferramentas de tarefas. A pessoa extrai o arquivo e abre `slides.html` no navegador. Não exponha o HTML fonte, CSS, JavaScript, metadados de empacotamento ou evidência de revisão como navegação de estudo.
