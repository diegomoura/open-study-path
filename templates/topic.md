...
A mesma versão materializada também gera fontes HTML internas em `slides`, o PDF learner-facing em `slides_pdf` e a revisão especializada em `slides_review`. Somente o PDF aparece na aula e nas ferramentas de tarefas. Não exponha o HTML, CSS, JavaScript, metadados de renderização ou evidência de revisão como navegação de estudo.
